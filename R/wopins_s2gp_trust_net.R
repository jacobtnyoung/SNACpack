#' WOPINS Trust Network (Site 2, General Population Unit)
#'
...
#'
#' @format An `network` object with 76 nodes and 207 edges.
#'
#' @details
#' Vertex attributes:
...
#'
#' @examples
#' data( wopins_s2gp_trust_net )
#' sna::gplot( wopins_s2gp_trust_net )
"wopins_s2gp_trust_net"
